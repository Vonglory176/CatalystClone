...
export default function HomeLayout() {
    ...
    useLayoutEffect(() => {
        ...
        // Clean up
        return () => {
            document.head.removeChild(preloadHighRes);
        }
    }, [])
